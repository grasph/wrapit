...
if(WRAPIT_EXECUTABLE)
    add_custom_command(
        OUTPUT ${CMAKE_BINARY_DIR}/lib${CMAKE_PROJECT_NAME}/src/${WRAPIT_TEST_CXX_FILE}
        COMMAND ${WRAPIT_EXECUTABLE} --force -v 1 ${CMAKE_BINARY_DIR}/${CMAKE_PROJECT_NAME}.wit
...
# Build the library
add_library(${WRAPIT_TEST_LIB_FILE} SHARED ${CMAKE_BINARY_DIR}/libTestStdString/src/${WRAPIT_TEST_CXX_FILE})
